...
Feature: UUri Micro Serialization
  ...
  Scenario Outline: Testing uuri micro serializer - python
    Given "python" creates data for "micro_serialize_uri"
  ...
  Scenario Outline: Testing uuri micro serializer - java
    Given "java" creates data for "micro_serialize_uri"
      And sets "authority.id" to "<authority_id>"
      And sets "authority.name" to "<authority_name>"
      And sets "entity.id" to "<entity_id>"
      And sets "entity.name" to "<entity_name>"
