...
Feature: Local and Remote URI serialization
  ...
  Scenario Outline: Testing the local uri serializer - python
    Given "python" creates data for "uri_serialize"
  ...
  Scenario Outline: Testing the local uri serializer - java
    Given "java" creates data for "uri_serialize"
    And sets "entity.name" to "<entity_name>"
    And sets "entity.version_major" to "<entity_version_major>"
    And sets "resource.name" to "<resource_name>"
    And sets "resource.instance" to "<resource_instance>"
  ...
  Scenario Outline: Testing the remote uri serializer - python
    Given "python" creates data for "uri_serialize"
  ...
  Scenario Outline: Testing the remote uri serializer - java
    Given "java" creates data for "uri_serialize"
    And sets "authority.name" to "<authority_name>"
    And sets "entity.name" to "<entity_name>"
    And sets "entity.version_major" to "<entity_version_major>"
