...
Feature: Local and Remote URI de-serialization
  ...
  Scenario Outline: Testing the local uri deserializer - python
    Given "python" creates data for "uri_deserialize"
  ...
  Scenario Outline: Testing the local uri deserializer - java
    Given "java" creates data for "uri_deserialize"
    When sends a "uri_deserialize" request with serialized input "<serialized_uri>"
    Then the deserialized uri received should have the following properties:
      | Field                | Value                  |
      | entity.name          | <entity_name>          |
  ...
  Scenario Outline: Testing the remote uri deserializer - python
    Given "python" creates data for "uri_deserialize"
    When sends a "uri_deserialize" request with serialized input "<serialized_uri>"
    Then the deserialized uri received should have the following properties:
      | Field                | Value                  |
  ...
  Scenario Outline: Testing the remote uri deserializer - java
    Given "java" creates data for "uri_deserialize"
    When sends a "uri_deserialize" request with serialized input "<serialized_uri>"
    Then the deserialized uri received should have the following properties:
      | Field                | Value                  |
