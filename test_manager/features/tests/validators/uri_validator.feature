...
Feature: URI Validation
  ...
  Scenario Outline: Validate different types of URIs - python
    Given "python" creates data for "uri_validate"
      And sets "uri" to "<uri>"
  ...
  Scenario Outline: Validate different types of URIs - java
    Given "java" creates data for "uri_validate"
      And sets "uri" to "<uri>"
      And sets "type" to "<validation_type>"
